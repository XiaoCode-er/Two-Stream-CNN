...
from keras.layers import Activation, Dropout, Flatten, concatenate, Maximum, Add, Average
...
weight_path = 'F:/NTU60/weights/second/average.h5'
...
def model():
    ...
    up_feature = Average()([up_feature_0, up_feature_1])
    down_feature = Average()([down_feature_0, down_feature_1])
